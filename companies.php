...
<div class="header">
    <div class="pic-header col" id="companies-header">
        <h1 class="centered">FIND ENTERTAINMENT</h1>
        <div class="col-6 centered"><p class="description-2">Browse companies and activities seraching by area, name or keyword</p></div>
    </div>
</div>
</section>
...
<section id="complist"  class="list">
...
<section id="actlist" class="list">
    <div class="col-6 col centered">    
    <h3>Activities</h3>
    <p>Find activity by name, community name or keyword
        <div class="col-3">
